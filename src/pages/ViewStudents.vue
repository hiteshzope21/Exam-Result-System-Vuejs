  ...
  <div>
    ...
    <div class="container" v-if="!loading">
      <div class="row align-item-center">
        <div class="col-md-6">
          <div class="list-group">
            <ul class="list-group">
              ...
              <li class="list-group-item">
                Fathre's Name:
                <span class="fw-bold">{{ student.students.fathername }}</span>
              </li>
              <li class="list-group-item">
                Email: <span class="fw-bold">{{ student.students.email }}</span>
              </li>
              <li class="list-group-item">
                Semester:
                <span class="fw-bold">{{ student.students.semester }}</span>
              </li>
              <li class="list-group-item">
                Enrollment Number:
                <span class="fw-bold">{{ student.students.enrollment }}</span>
              </li>
              <li class="list-group-item">
                Mobile:
                <span class="fw-bold">{{ student.students.mobile }}</span>
              </li>
              <li class="list-group-item">
                College:
                <span class="fw-bold">{{ student.students.college }}</span>
              </li>
              <br />
            </ul>
        ...
        <div class="row mt-3">
          <div class="col">
            <router-link to="/faculty" class="btn btn-success"
